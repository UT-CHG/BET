...
# def random_sample_set_old(sample_type, input_obj, num_samples,
...
class sampler(object):
    ...
    def save(self, savefile, globalize=True):
        util.save_object(save_set=self, file_name=savefile, globalize=globalize)
...
#
#         return random_sample_set_old(sample_type, input_obj, num_samples,
#                                  criterion, globalize)
#
#     def regular_sample_set(self, input_obj, num_samples_per_dim=1):
#         """
