...
class TestExactRadii(unittest.TestCase):
    """
    Test :meth:`bet.calculateP.calculateP.exact_radii`.
    """
    ...
    def setUp(self):
        ...
        self.s_set.exact_radii(normalize=False)
        self.s_set.exact_radii()
    ...
    def test_radii(self):
        ...
        samples.
        """
        nptest.assert_array_almost_equal(self.rad, self.radii_exact)
        nptest.assert_array_almost_equal(self.norm_rad, self.radii_exact)
