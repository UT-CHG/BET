...
class test_uniform_partition_uniform_distribution_rectangle_scaled_01D(data_01D,
    ...
    def setUp(self):
        ...
        super(test_uniform_partition_uniform_distribution_rectangle_scaled_01D,
              self).createData()
        super(
            test_uniform_partition_uniform_distribution_rectangle_scaled_01D, self).setUp()
...
class normal_partition_normal_distribution(prob):
    ...
    def setUp(self):
        ...
        self.data_prob = sFun.normal_partition_normal_distribution(
            None, self.Q_ref, std=std, M=67, num_d_emulate=1E3)
        self.d_distr_samples = self.data_prob.get_values()
        self.rho_D_M = self.data_prob.get_probabilities()
...
class uniform_partition_normal_distribution(prob):
    ...
    def setUp(self):
        ...
        if not isinstance(self.Q_ref, np.ndarray) and not isinstance(
            ...
            std = np.ones(self.Q_ref.shape)
        self.data_prob = sFun.uniform_partition_normal_distribution(
            None, self.Q_ref, std=std, M=67, num_d_emulate=1E3)
        self.d_distr_samples = self.data_prob.get_values()
        self.rho_D_M = self.data_prob.get_probabilities()
...
class test_regular_partition_uniform_distribution_rectangle_size_int_01D(data_01D,
    ...
    def setUp(self):
        ...
        Set up problem.
        """
        super(test_regular_partition_uniform_distribution_rectangle_size_int_01D,
              self).createData()
        super(
            test_regular_partition_uniform_distribution_rectangle_size_int_01D, self).setUp()
...
class test_regular_partition_uniform_distribution_rectangle_size_int_1D(data_1D,
    ...
    def setUp(self):
        ...
        Set up problem.
        """
        super(test_regular_partition_uniform_distribution_rectangle_size_int_1D,
              self).createData()
        super(
            test_regular_partition_uniform_distribution_rectangle_size_int_1D, self).setUp()
...
class test_regular_partition_uniform_distribution_rectangle_size_int_2D(data_2D,
    ...
    def setUp(self):
        ...
        Set up problem.
        """
        super(test_regular_partition_uniform_distribution_rectangle_size_int_2D,
              self).createData()
        super(
            test_regular_partition_uniform_distribution_rectangle_size_int_2D, self).setUp()
...
class test_regular_partition_uniform_distribution_rectangle_size_int_3D(data_3D,
    ...
    def setUp(self):
        ...
        Set up problem.
        """
        super(test_regular_partition_uniform_distribution_rectangle_size_int_3D,
              self).createData()
        super(
            test_regular_partition_uniform_distribution_rectangle_size_int_3D, self).setUp()
...
class test_regular_partition_uniform_distribution_rectangle_size_list_1D(data_1D,
    ...
    def setUp(self):
        ...
        super(test_regular_partition_uniform_distribution_rectangle_size_list_1D,
              self).createData()
        super(
            test_regular_partition_uniform_distribution_rectangle_size_list_1D, self).setUp()
...
class test_regular_partition_uniform_distribution_rectangle_size_list_2D(data_2D,
    ...
    def setUp(self):
        ...
        Set up problem.
        """
        super(test_regular_partition_uniform_distribution_rectangle_size_list_2D,
              self).createData()
        super(
            test_regular_partition_uniform_distribution_rectangle_size_list_2D, self).setUp()
...
class uniform_partition_uniform_distribution_data_samples(prob_uniform):
    ...
    def setUp(self):
        ...
        Set up problem.
        """
        self.data_prob = sFun.uniform_partition_uniform_distribution_data_samples(
            self.data)
        self.d_distr_samples = self.data_prob.get_values()
        self.rho_D_M = self.data_prob.get_probabilities()
...
class test_uniform_partition_uniform_distribution_rectangle_domain_01D(data_01D,
    ...
    def setUp(self):
        ...
        Set up problem.
        """
        super(test_uniform_partition_uniform_distribution_rectangle_domain_01D,
              self).createData()
        super(
            test_uniform_partition_uniform_distribution_rectangle_domain_01D, self).setUp()
