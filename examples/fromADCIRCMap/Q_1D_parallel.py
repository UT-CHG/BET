...
def postprocess(station_nums, ref_num):
    ...
    if rank == 0:
        print "Consolidating prob"
        mdict = dict()
        mdict['P1'] = util.get_global_values(P1)
    ...
    if rank == 0:
        print "Consolidating prob_emulated"
        mdict['P0'] = util.get_global_values(P0)
        mdict['lem0'] = lem0
