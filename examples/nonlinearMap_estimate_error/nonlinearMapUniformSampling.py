...
input_samples.set_domain(np.array([[0.0, 1.0],
                                   [0.0, 1.0],
                                   [0.0, 1.0]]))
my_disc = sampler.create_random_discretization(
    "random", input_samples, num_samples=1000)
...
my_disc_exact._output_sample_set._values_local = my_disc._output_sample_set._values_local + \
    my_disc._output_sample_set._error_estimates_local
